          ...
          <div class="col-md-5">
            	<div class="panel panel-defaultt">
	                ...
	                <div class="panel-body">
		                ...
		                <div class="col-sm-12">
	                      <div class="col-sm-6">
	                        <input data-toggle="counter" data-end="" data-prefix="&#8361 " type="text" class="form-control" id="targetPrice">
	                      </div>
	                      <div class="col-sm-6 btn" style="padding: initial;">
	                      	<button type="button" id="setBudget" class="btn btn-space btn-success" style="font-size: 14px;"><i class="icon icon-left s7-piggy" style="font-size: 26px;"></i> 예산 설정</button>
	                      </div>
	                    </div>
	                </div>
                </div>
							...
							<div class="col-md-12">
								<div class="widget widget-tile widget-tile-wide">
									...
									<div class="tile-value">
										<span id="spendMonth" data-toggle="counter" data-end="" data-prefix="&#8361 "></span>
										<span id="averMonth" data-toggle="counter" data-end="" data-prefix="&#8361 " data-suffix=" /일"
											class="ave"></span>
							...
							<div class="col-md-12">
								<div class="widget widget-tile widget-tile-wide">
									...
									<div class="tile-value">
										...
										<span id="canMonth" data-toggle="counter" data-end="18.6" data-decimals="0" data-prefix="&#8361 " data-suffix=" /일" class="ave"></span>
