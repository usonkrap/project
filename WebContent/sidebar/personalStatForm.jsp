...
#img_1 {
	background-image:
		url('http://icons.iconarchive.com/icons/graphicloads/food-drink/256/drink-icon.png');
	width: 50px;
}
...
.am-checkbox.inline+.am-checkbox.inline, .am-checkbox.inline+.am-radio.inline,
	.am-radio.inline+.am-checkbox.inline, .am-radio.inline+.am-radio.inline
	{
	margin-left: initial;
}
</style>
...
<body>
		...
		<nav class="navbar navbar-default navbar-fixed-top am-top-header">
			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					</a> <a href="../sidebar/main.action" class="navbar-brand">
						<!-- 메인 페이지 링크 및 로고 표시 -->
					</a>
				</div>
					...
					<ul class="nav navbar-nav navbar-right am-user-nav">
						<li class="dropdown"><a href="#" data-toggle="dropdown"
							...
							<ul role="menu" class="dropdown-menu">
								...
								<li><a href="../customer/logout.action"> <span
										class="icon s7-power"></span>로그 아웃
								</a></li>
							</ul></li>
					</ul>
		...
		<div class="am-left-sidebar">
			<div class="content">
              ...
              <li class="nav-items"><div class="am-scroller nano has-scrollbar"><div class="content nano-content" style="margin-right: 0px; right: -17px;"><ul><li><a href="charts-flot.html">Flot</a>
					...
					<li class="parent"><a
						href="../sidebar/personalStatForm.action" class="select"><i
			...
			<div class="main-content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<span class="title" style="padding: 20px;">월별 지출 비교 <select
									class="form-control" style="width: 15%; float: right;" id="year">
							...
							<div class="panel-body">
								...
								<div style="margin-top: 3em;">
									<label class="col-sm-3 control-label" style="font-size: 1.5em;">카테고리
										선택</label>
									<div class="field" style="float: right">
										<span>전체 선택 &nbsp;</span>
										<div class="pull-right">
											<div class="switch-button switch-button-xs">
												<input type="checkbox" name="swt1" id="swt1"><span>
									...
									<div class="col-sm-12" id="checkBoxArea">
										<div class="col-sm-2">
											<div class="am-checkbox inline col-sm-12">
												<input id="check1" type="checkbox" class="box" value="0">
												<label for="check1" id="check1">외식</label>
											</div>
											<div class="am-checkbox inline col-sm-12">
												<input id="check2" type="checkbox" class="box" value="1">
												<label for="check2" id="check2">식음료</label>
											</div>
										</div>
										<div class="col-sm-2">
											<div class="am-checkbox inline col-sm-12">
												<input id="check3" type="checkbox" class="box" value="2">
												<label for="check3" id="check3">교통</label>
											</div>
											<div class="am-checkbox inline col-sm-12">
												<input id="check4" type="checkbox" class="box" value="3">
												<label for="check4" id="check4">패션/미용</label>
											</div>
										</div>
										<div class="col-sm-2">
											<div class="am-checkbox inline col-sm-12">
												<input id="check5" type="checkbox" class="box" value="4">
												<label for="check5" id="check5">문화생활</label>
											</div>
											<div class="am-checkbox inline col-sm-12">
												<input id="check6" type="checkbox" class="box" value="5">
												<label for="check6" id="check6">생활용품</label>
											</div>
										</div>
										<div class="col-sm-2">
											<div class="am-checkbox inline col-sm-12">
												<input id="check7" type="checkbox" class="box" value="6">
												<label for="check7" id="check7">사회생활</label>
											</div>
											<div class="am-checkbox inline col-sm-12">
												<input id="check8" type="checkbox" class="box" value="7">
												<label for="check8" id="check8">교육</label>
											</div>
										</div>
										<div class="col-sm-2">
											<div class="am-checkbox inline col-sm-12">
												<input id="check9" type="checkbox" class="box" value="8">
												<label for="check9" id="check9">주거/관리/통신</label>
											</div>
											<div class="am-checkbox inline col-sm-12">
												<input id="check10" type="checkbox" class="box" value="9">
												<label for="check10" id="check10">의료/건강</label>
											</div>
										</div>
										<div class="col-sm-2">
											<div class="am-checkbox inline col-sm-12">
												<input id="check11" type="checkbox" class="box" value="10">
												<label for="check11" id="check11">금융</label>
											</div>
											<div class="am-checkbox inline col-sm-12">
												<input id="check12" type="checkbox" class="box" value="11">
				...
				<div class="row">
					...
					<div style="width: 50%; float: right;">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<span class="title">카테고리별 지출 <select class="form-control"
									style="width: 25%; float: right;" id="subCategory">
										<option>외식</option>
										<option>식음료</option>
										<option>교통</option>
										<option>패션/미용</option>
	...
	<script data-require="flot@0.8.2" data-semver="0.8.2"
	...
	<script src="../assets/js/personalStat-subcategory.js"
		type="text/javascript"></script>
</body>
</html>
