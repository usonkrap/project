...
<body id="home">
	...
	<!-- FullScreen -->	<!-- background: general.css 244line -->
    <div class="intro-header">
		<div class="col-xs-12 text-center abcen1">
			<h1 class="h1_home wow fadeIn" data-wow-delay="0.4s">何を買いましたか？</h1>
			<h3 class="h3_home wow fadeIn" data-wow-delay="0.6s">あなたの消費のパタンを分析いたします.</h3>
			<ul class="list-inline intro-social-buttons">
				<li><a href="customer/loginForm.action" class="btn btn-lg mybutton_cyano wow fadeIn" data-wow-delay="0.8s"><span class="network-name">PACHIRISを始める</span></a>
				</li>
	...
	<nav class="navbar-default" role="navigation">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#home">PACHIRIS</a>
			</div>
				...
				<div class="col-sm-6  block wow bounceIn">
					<div class="row">
						...
						<div class="col-md-8 box-ct">
							<h3> CAPTURE </h3>
							<p> レシートの写真を撮りましょう。簡単に支出の登録ができます。 </p>
						</div>
				  </div>
			  </div>
			  <div class="col-sm-6 block wow bounceIn">
					<div class="row">
					  ...
					  <div class="col-md-8 box-ct">
						<h3> GOAL </h3>
						<p> 目標を立てて達成してみましょう。計画的消費生活が始まります。 </p> 
					  </div>
					</div>
			  </div>
		  </div>
		  ...
		  <div class="row tworow">
				<div class="col-sm-6  block wow bounceIn">
					<div class="row">
						...
						<div class="col-md-8 box-ct">
							<h3> STATISTICS </h3>
							<p> 様々な分析グラフを提供します。ご自身の消費パタンを確認できます。 </p>
						</div>
				  </div>
			  </div>
			  <div class="col-sm-6 block wow bounceIn">
					<div class="row">
					  ...
					  <div class="col-md-8 box-ct">
						<h3> INFORMATION</h3>
						<p> どんどん登録すると、内容に合わせた情報が提供されます。 </p> 
					  </div>
					</div>
			  </div>
		  </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 wow fadeInLeftBig"  data-animation-delay="200">   
                    <h3 class="section-heading">concept 1</h3>
					<div class="sub-title lead3">Lorem ipsum dolor sit atmet sit dolor greand fdanrh<br> sdfs sit atmet sit dolor greand fdanrh sdfs</div>
                    <p class="lead">
                    	"영수증은 버려주세요" 더이상은 NAVER. 
                    	버려지는 영수증~ 
                    	이제 모아~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                    	블라블라~~\
            ...
            <div class="row">
                <div class="col-sm-6 wow fadeInLeftBig">
                     <div id="owl-demo-1" class="owl-carousel">
						<a href="img/kaho1.jpg" class="image-link">
							<div class="item">
								<img  class="img-responsive img-rounded" src="img/kaho1.jpg" alt="">
							</div>
						</a>
						<a href="img/suzu1.jpeg" class="image-link">
							<div class="item">
								<img  class="img-responsive img-rounded" src="img/suzu1.jpeg" alt="">
							</div>
						</a>
						<a href="img/nana.jpg" class="image-link">
							<div class="item">
								<img  class="img-responsive img-rounded" src="img/nana.jpg" alt="">
							</div>
						</a>
					</div>       
                </div>
                ...
                <div class="col-sm-6 wow fadeInRightBig"  data-animation-delay="200">   
                    <h3 class="section-heading">concept 2</h3>
					<div class="sub-title lead3">Lorem ipsum dolor sit atmet sit dolor greand fdanrh<br> sdfs sit atmet sit dolor greand fdanrh sdfs</div>
                    <p class="lead">
    ...
    <div class="content-section-a">
        ...
        <div class="container">
             ...
             <div class="row">
                ...
                <div class="col-sm-6 wow fadeInLeftBig"  data-animation-delay="200">   
                    <h3 class="section-heading">concept 3</h3>
	...
	<div id="signup" class="banner">
		<div class="container">
			<div class="row">
				...
				<p><a href="customer/joinForm.action" class="btn btn-embossed btn-primary view" style="width: 350px; font-size: 20px" role="button">会員登録</a></p> 
			 </div>
			</div>
		</div>
	</div>
