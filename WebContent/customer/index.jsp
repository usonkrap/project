    ...
    <div class="intro-header">
		<div class="col-xs-12 text-center abcen1">
			...
			<ul class="list-inline intro-social-buttons">
				<li><a href="customer/loginForm.action" class="btn btn-lg mybutton_cyano wow fadeIn" data-wow-delay="0.8s"><span class="network-name">PACHIRIS 시작하기</span></a>
				</li>
			...
			<div class="col-md-6 col-md-offset-3 text-center wrap_title">
			  ...
			  <div class="col-sm-6 block wow bounceIn">
					<div class="row">
					  ...
					  <div class="col-md-8 box-ct">
						<h3> GOAL </h3>
						<p> 목표를 세우고 달성해보세요. 계획적인 소비습관의 시작입니다. </p> 
					  </div>
					</div>
			  </div>
		  </div>
		  ...
		  <div class="row tworow">
				<div class="col-sm-6  block wow bounceIn">
					<div class="row">
						...
						<div class="col-md-8 box-ct">
							<h3> STATISTICS </h3>
							<p> 다양한 통계를 제공합니다. 나의 소비패턴을 확인해 보세요.</p>
						</div>
				  </div>
			  </div>
			  <div class="col-sm-6 block wow bounceIn">
					<div class="row">
					  ...
					  <div class="col-md-8 box-ct">
						<h3> INFORMATION</h3>
						<p> 꾸준히 등록해주세요. 맞춤형 정보를 제공해드립니다. </p> 
					  </div>
					</div>
			  </div>
		  </div>
